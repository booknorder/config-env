...
function __repo_init_helm() {
  export HELM_PLUGIN_S3_VERSION="${HELM_PLUGIN_S3_VERSION-0.17.0}"
  export HELM_PLUGIN_DIFF_VERSION="${HELM_PLUGIN_DIFF_VERSION-3.13.0}"
  export HELM_PLUGIN_DASHBOARD_VERSION="${HELM_PLUGIN_DASHBOARD_VERSION-1.3.3}"
  export HELM_PLUGIN_SECRETS_VERSION="${HELM_PLUGIN_SECRETS_VERSION-4.6.10}"
  export HELM_PLUGIN_GIT_VERSION="${HELM_PLUGIN_GIT_VERSION-0.16.0}"
  export HELM_PLUGIN_MAPKUBEAPIS_VERSION="${HELM_PLUGIN_MAPKUBEAPIS_VERSION-0.6.1}"
